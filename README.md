...
## UniDone — це MVP менеджера студентських завдань. 
Проєкт створюється в рамках лабораторних робіт для вивчення сучасних практик розробки, автоматизованого розгортання та продуктової аналітики.
